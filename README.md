...
<p align="center">
  ...
  Распаковка <code>.sodb</code>, просмотр кейсов, людей, паролей, убийц/криминалов и аккуратное редактирование базовых параметров игрока.
</p>
...
- вкладка **Кейсы**: активные дела, цели, связанные ID;
- вкладка **Люди / связи**: все citizens, HumanID, имена, работа, цель, координаты, связи;
...
- Перед `overwrite` всегда делай бэкап.
...
- [ ] Более красивый граф связей между citizens.
- [ ] Экспорт таблиц в CSV.
- [ ] Расширенный поиск по evidence/interactables.
- [ ] Автоматическое определение адресов/комнат по RoomID.
